...
public class fCheckIn {
    ...
    public DefaultTableModel mostrar(){
        ...
        String [] titulos= {"Nombre","Teléfono","Sexo","Correo","Fecha CheckIn", "No.Camas", "Precio","Tipo Pago"};
        ...
        try {
            ...
            while(rs.next()){
                ...
                registro [5]=rs.getString("num_camas");
    ...
    public boolean insertar (vCheckIn dts){
        ...
        sSQL="insert into Cliente_Habitacion (nombre_cli, tel_cli, sexo_cli, correo_cli, fecha_llegada, num_camas,cuenta, tipopago)"+
                "values (?,?,?,?,?,?,?,?)";
